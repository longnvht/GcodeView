...
namespace Gcody
{
    public partial class MainForm : Form
    {
        ...
        string defaultFilePath = "Untitled.nc";
        ...
        private void AutosaveTimer_Tick(object sender, EventArgs e)
        {
            ...
            File.WriteAllText(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "autosave.nc"), text);
        }
